...
function invocarMetodo(objeto, metodo) {
  ...
  // Tu código:
  objeto[metodo](); //No entiendo del todo esto de los parentesis :( 
}
...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // // Tu código:
  var arrayamigo = usuario.amigos;

  arrayamigo.push(nuevoAmigo);

  usuario['amigos'] = arrayamigo;
  return (usuario);
...
function sumarLikesDeUsuario(usuario) {
  ...
  for (let i = 0; i < usuario.posts.length; i++) {
    totales = usuario.posts[i].likes + totales;
